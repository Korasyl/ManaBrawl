extends SpellEntity
class_name IceSpikeBurst

@export var warmup_time: float = 0.25
@export var burst_radius: float = 30.0
@export var burst_damage: float = 22.0
@export var burst_interrupt: String = "stagger"
@export var telegraph_color: Color = Color(0.55, 0.85, 1.0, 0.35)
@export var impact_color: Color = Color(0.75, 0.95, 1.0, 0.95)
